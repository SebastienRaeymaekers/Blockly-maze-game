...
public class MyCanvasWindow extends CanvasWindow {
    ...
    public static void main(String[] args) {
        // todo maybe cool icon? :)
        java.awt.EventQueue.invokeLater(() -> new MyCanvasWindow("Blockr", args[0]).show());
    }

    @Override
    public void paint(Graphics g) {
        ((Graphics2D) g).scale(widthScale, heightScale); // scale with the window
        GUIDrawer.paintGame(g, eventHandler.getAreaController(), eventHandler.getExecutionController());
    }
